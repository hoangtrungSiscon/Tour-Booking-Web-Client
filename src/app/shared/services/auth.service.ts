...
export class AuthService {
    ...
    public checkOtp(request: any): Observable<any> {
        return this.http.post(`${this.url}/checkOtp`, request);
    }

    public login(request: any): Observable<any> {
        return this.http.post(`${this.url}/login`,request, {responseType: 'text'});
    }
